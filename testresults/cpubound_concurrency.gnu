...
set output "../cpubound_concurrency.png"

plot 't_cpubound-concurrency.csv' using 2:xticlabels(1) title columnheader(2), '' using 3:xticlabels(1) title columnheader(3), '' using 4:xticlabels(1) title columnheader(4)